...
export default function JEEExam() {
    ...
    const syllabus = [
        ...
        },
        {
            ...
            items: [
                ...
                "Electrochemistry, Solutions, Surface Chemistry",
            ],
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                "Previous 10-Year JEE Mains PYQ Practice",
    ...
    const projects = [
        {
            name: "Chapter-wise Practice Tests",
            desc: "Improve accuracy with topic-based tests and instant solutions.",
        },
        {
            name: "JEE Mains Mock Tests",
            desc: "Full-length tests following NTA pattern with rank prediction.",
        },
        {
            name: "Formula & Concept Revision Sheets",
            desc: "Special revision sheets for last-minute preparation.",
        },
        {
            name: "Performance Tracking Dashboard",
            desc: "AI-based score analysis and weak topic identification.",
        },
    ];
